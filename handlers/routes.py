...
async def process_tariffs(callback: CallbackQuery):
    await callback.message.answer(
        ...
        '🗑 <b>Базовый тариф</b>\n'
        'До 5 этажа, несрочно: <b>120–150 ₽</b>\n\n'

        '⚡️ <b>Надбавки</b>\n'
        '• Выше 5 этажа: +20 ₽ за каждый этаж\n'
        '• Срочно (за 20 минут): +50 ₽\n'
        '• Непогода (дождь, метель): ×2\n\n'

        '📦 <b>Подписка «Пакет в день»</b>\n'
        '1990 ₽/мес — вынос от <b>66–70 ₽</b>\n\n'
